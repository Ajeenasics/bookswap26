              ...
              <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      <Link to="/library_view_books" className="nav-link active" id="navheaders">MY BOOKS</Link>
                    </li>
                    <li className="nav-item">
                      <Link to="/library-view-events" className="nav-link active" id="navheaders">EVENTS</Link>
                    </li>
                    <li className="nav-item">
                      <Link to="/library-events" className="nav-link active" id="navheaders">ADD EVENT</Link>
                    </li>
                    <li className="nav-item">
...
//                     </li>
//                     <li className="nav-item">
//                       <Link to="/library_about" className="nav-link" href="#!" id="navheaders">
//                         ABOUT
//                       </Link>
//                     </li>
//                     <li className="nav-item">
...
//                     </li>
//                     <li className="nav-item">
//                       <Link to="/library_view_members" className="nav-link" href="#!" id="navheaders">
//                         MEMBERS
//                       </Link>
//                     </li>
//                     <li className="nav-item">
//                       {/* <Link to="/library_donatebook" className="nav-link" href="#!" id="navheaders">
//                         DONATE
//                       </Link> */}
...
//                     </li>
//                     <li className="nav-item">
//                       {/* <Link to="/librarybnotificationpage" className="nav-link">
//                         <AiFillBell />
//                       </Link> */}
