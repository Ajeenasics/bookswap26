    ...
    <div className="reader_profile_sidebar">
      <div className="reader_profile_sidebar_img mt-5">
        ...
        <div className="reader_profile_sidebar_camerabg">
          <Link to='/reader_edit_profile'><i className="ri-camera-line"></i></Link>
        </div>
      </div>
      ...
      <div className="reader_profile_sidebar_settings reader_profile_sidebar_padding ">
        <i className="ri-settings-3-fill reader_profile_sidebar_icons"></i>
        <p>Settings</p>
      </div>
      <hr />
        ...
        <Link to='/reader_profile_account_info' >
          <div className="reader_profile_sidebar_account_info">
            <div className="d-flex mt-2">
              <i className="ri-user-2-fill reader_profile_sidebar_icons"></i>
              <p> Account Info</p>
            </div>

            <div className="mt-2">
              <i className="ri-arrow-right-s-line reader_profile_sidebar_icons"></i>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="reader_profile_sidebar_padding ">
        <Link to='/reader_profile_notification' >
          <div className="reader_profile_sidebar_account_info">
            <div className="d-flex mt-2 ">
              <i className="ri-notification-3-fill reader_profile_sidebar_icons"></i>{" "}
              <p> Notifications</p>
            </div>
      ...
      <div className="reader_profile_sidebar_padding ">
        <Link to='/reader_profile_club' >
          <div className="reader_profile_sidebar_account_info">
            <div className="d-flex mt-2">
              <i className="ri-book-open-fill reader_profile_sidebar_icons"></i>
              <p> Library</p>
            </div>
      ...
      <div className="reader_profile_sidebar_padding ">
        <Link to='/reader_profile_donation' >
          <div className="reader_profile_sidebar_account_info">
            <div className="d-flex mt-2">
              <i className="ri-hand-heart-fill reader_profile_sidebar_icons"></i>
              <p> Donation</p>
            </div>
      ...
      <div className="reader_profile_sidebar_padding ">
        <Link to='/reader_profile_help' >
          <div className="reader_profile_sidebar_account_info">
            <div className="d-flex mt-2">
              <i className="ri-question-fill reader_profile_sidebar_icons"></i>
              <p> Help</p>
            </div>
      ...
      <div className="reader_profile_sidebar_padding ">
        <Link to='/reader_profile_privacy' >
          <div className="reader_profile_sidebar_account_info">
            <div className="d-flex mt-2">
              <i className="ri-error-warning-fill reader_profile_sidebar_icons"></i>
